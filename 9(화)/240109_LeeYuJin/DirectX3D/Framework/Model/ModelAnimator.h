...
{
	// 모델의 움직임을 관리하는 클래스, 혹은 움직임을 보여줄 모델 그 자체까지
...
protected:
	...
	// 클립에서 트랜스폼 정보 재생성
	void CreateClipTransform(UINT index); // 무엇으로 부터 생성할 것인가
	...
	// 텍스처 클래스를 다 써도 되는데 모델의 경우 정점 등에 대한 연산, 기능이 메시와 다른 기능에 있어서
	// 굳이 만들어진 클래스를 안 써도 일단 DX 제공 클래스를 쓸 수 있다
