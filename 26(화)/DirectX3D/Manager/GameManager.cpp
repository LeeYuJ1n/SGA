...
// 2. 그런데 클릭을 했을 때 받은 좌표를 브러시에 완전히 전달하는데 약간 미스가 있다

// 오늘의 실습 ( 완성 )
// 1. 빠뜨린 "좌표를 정확히 전달 주고받기"를 추가하는 부분에 도전해서, 
//    지형을 원형 브러시로 편집
// 2. "1번을 성공했다면", 지난주에 지형 위에 올린 공을 다시 한 번 올려봅시다
//    공이 지면을 따라 움직일 수 있도록 할 수 있는지 연구해봅시다
