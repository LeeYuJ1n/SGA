...
public:
	...
	struct ParticleData
	{
		...
		Vector3 minAcceleration; // 최소 가속력(속도 변화량)
		Vector3 maxAcceleration; // 최대 가속력(속도 변화량)
		Vector3 manStartScale = { 1, 1, 1 }; // 생성시 최소 크기
