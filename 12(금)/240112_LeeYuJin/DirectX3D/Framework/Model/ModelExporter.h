...
private:
    ...
    // FBX가 안에 프레임, 메쉬, 텍스처까지 다 갖고 있는 경우, 텍스처를 빼기 위한 함수
...
// 메쉬
    ...
    void WriteMesh(); // 다 읽은 데이터로 결과 메쉬 만들기

    // 동작
    Clip* ReadClip(aiAnimation* animation); // aiAnimation : 애셋 임포트 라이브러리의 애니메이션 관리 클래스
...
private:
    //애셋 임포트 라이브러리 사용 : 읽어들이기 클래스
    Assimp::Importer* importer; // import : 읽어오기, export : 써서 보내기
