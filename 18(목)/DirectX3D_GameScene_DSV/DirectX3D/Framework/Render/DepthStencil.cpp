...
DepthStencil::DepthStencil(IN UINT width, IN UINT height, IN bool isStencil)
...
void DepthStencil::CreateDSVTexture()
{
	...
	// DX용 부가 옵션 : "이 설명 구조체는 뎁스 스텐실이고, 셰이더 리소스이기도 합니다"
...
void DepthStencil::CreateDSV()
{
	...
	depthViewDesc.ViewDimension = D3D11_DSV_DIMENSION_TEXTURE2D; // 데이터 규묘는 텍스처에서 요구하는 만큼
