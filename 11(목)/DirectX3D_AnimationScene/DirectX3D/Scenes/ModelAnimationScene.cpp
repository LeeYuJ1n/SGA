...
ModelAnimationScene::ModelAnimationScene()
{
    ...
    modelAnimator->ReadClip("Punching");
    modelAnimator->ReadClip("Run");
    modelAnimator->ReadClip("RunBack");
    modelAnimator->ReadClip("RunLeft");
    modelAnimator->ReadClip("RunRight");
