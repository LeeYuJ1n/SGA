...
void Collider::Render()
{
    ...
    if (isRenderAsLine) //렌더 출력 방식
    {
        ...
        // D3D11_PRIMITIVE_TOPOLOGY 열거형 : 파이프라인이 입력 어셈블러 단계에 바인딩된 꼭짓점 데이터를 해석하는 방법입니다. 
        //                                   이러한 기본 토폴로지 값은 꼭짓점 데이터가 화면에 렌더링되는 방법을 결정합니다.

        // D3D11_PRIMITIVE_TOPOLOGY_LINELIST : 꼭짓점 데이터를 선 목록으로 해석합니다.
    }
