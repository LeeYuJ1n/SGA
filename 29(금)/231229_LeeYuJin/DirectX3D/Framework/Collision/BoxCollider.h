...
class BoxCollider : public Collider
{
    ...
    // 1. 박스 생김새
    // 2. 박스 제작에 필요한 정보(=크기)
    // 3. (WinAPI, DX2D 때와 같은) 충돌 당시의 상황을 기록하기 위한 정보들
    //    (함수에서 직접 도출하거나 구조체를 만들거나)
...
public:
    ...
    virtual bool IsSphereCollision(class SphereCollider* collider) override;
